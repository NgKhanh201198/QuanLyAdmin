...
<head>
    ...
    <meta http-equiv="refresh" content="1.5, url=<?php echo base_url(); ?>admin/quanlygiangvien">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 221px;">
            <br><br>
            <div class="container">
                <h2 class="alert alert-success text-center">Bạn đã thêm thông tin tài khoản thành công!</h2>
             </div>
        </div>
        <!-- /.content-wrapper -->
    </div>
