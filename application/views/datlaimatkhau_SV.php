...
<head>
    ...
    <meta http-equiv="refresh" content="1.0, url=<?php echo base_url(); ?>admin/quanlytaikhoanSV">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 221px;">
            <br><br>
            <div class="container">
                <h2 class="alert alert-success text-center">Bạn đã đặt lại mật khẩu thành công thành công!</h2>
             </div>
        </div>
        <!-- /.content-wrapper -->
    </div>
